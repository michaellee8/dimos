...
impl Odometry {
    ...
    pub(crate) fn hash_recursive(parents: &mut Vec<u64>) -> u64 {
        ...
        tmphash = tmphash.wrapping_add(crate::geometry_msgs::PoseWithCovariance::hash_recursive(
            parents,
        ));
        tmphash = tmphash.wrapping_add(crate::geometry_msgs::TwistWithCovariance::hash_recursive(
            parents,
        ));
        parents.pop();
        // rotate left by 1
