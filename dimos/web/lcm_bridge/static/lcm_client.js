...
// Browser-side LCM client. Talks to the LCM<->WebSocket bridge
// (dimos/web/lcm_bridge) using the same wire format the rest of the
// dimos bus uses, via @dimos/msgs.
//
...
// Raw-channel variant for dimos types @dimos/msgs can't decode. The
...
// Auto-start so host pages don't need to know about us.
start();
