...
all_blueprints = {
    ...
    "xarm-voxel-planning-viser-demo": "dimos.robot.manipulators.xarm.blueprints.simulation:xarm_voxel_planning_viser_demo",
...
all_modules = {
    ...
    "tf-pose-source": "dimos.protocol.tf.tf_pose_source.TfPoseSource",
