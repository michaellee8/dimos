...
all_blueprints = {
    ...
    "unitree-go2-oav-draft": "dimos.robot.unitree.go2.blueprints.navigation.unitree_go2_oav_draft:unitree_go2_oav_draft",
...
all_modules = {
    ...
    "lidar-shield": "dimos.navigation.lidar_shield.module.LidarShield",
