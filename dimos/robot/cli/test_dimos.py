...
def test_blueprint_arg_help():
    ...
    assert output.split("\n") == [
        ...
        "      * testmodulea.static_publish_interval: float (default: 1.0)",
        ...
        "      * testmoduleb.static_publish_interval: float (default: 1.0)",
...
def test_blueprint_arg_help_required():
    ...
    assert output.split("\n") == [
        ...
        "      * testmodule.static_publish_interval: float (default: 1.0)",
