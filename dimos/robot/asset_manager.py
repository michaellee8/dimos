...
class RobotAssetPath(type(Path())):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *relative_parts: object,
        ...
        # Path subclasses receive the same constructor arguments in __init__ after
        # __new__; consume them so pathlib does not see DimOS-specific kwargs.
...
def default_robot_asset_manager() -> RobotAssetManager:
    ...
    if _DEFAULT_MANAGER is None:
        from dimos.robot.robot_asset_declarations import ROBOT_ASSETS
