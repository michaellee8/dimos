...
"""Go2 replay stack for validating H.264 video transport with 3D detection."""
...
from dimos.robot.unitree.go2.blueprints.smart.unitree_go2_h264_video import (
    unitree_go2_h264_video,
)
from dimos.robot.unitree.go2.connection import GO2Connection

unitree_go2_h264_detection = (
    autoconnect(
        unitree_go2_h264_video,
...
__all__ = ["unitree_go2_h264_detection"]
