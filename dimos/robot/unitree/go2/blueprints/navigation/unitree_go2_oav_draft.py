...
"""Draft: 3D navigation on Go2 with voxel-grid mapping, MLS planning, holonomic
trajectory control, and lidar shield obstacle avoidance over WebRTC.
...
unitree_go2_oav_draft = autoconnect(
    ...
    DanLocalPlanner.blueprint(resample_spacing_m=0.1, lock_replan=1.5),
