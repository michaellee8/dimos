...
Define the Robosuite runtime sidecar boundary for baked Robosuite task execution, motor-surface mapping, observation export, and score/artifact reporting.
