...
Define the deterministic manual MuJoCo grasp demo path that composes registered-object scanning, GPD grasp generation, and agent-facing grasp execution without an autonomous LLM loop.
